...
$(document).ready(function() {
  ...
  $('.respuesta,.respuesta2').bind('click',verificar_respuesta);
});
...
var verificar_respuesta = function() {
  ...
  if( !$('#'+PREG).hasClass('verificada') ) {
    ...
    $('.respuesta, .respuesta2').unbind('click');
...
var resultados = function() {
  ...
  $('#contenedor').addClass('resultados');
  ...
  if(estadistica__porcentaje == 100)
    estadistica__mensaje = "¡Excelente! lograste el mejor puntaje";
